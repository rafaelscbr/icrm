...
export function ForecastTab({ leads, campaign }: ForecastTabProps) {
  ...
  // ── Blocos do funil (campanha vai até "Agendou Apresentação") ──────────────
  const funnelBlocks = [
    {
      key:           'cold' as const,
      label:         'Base Fria',
    ...
    },
    {
      ...
      sublabel:      'Transferidos ao funil principal',
      dotColor:      'bg-violet-500',
      textColor:     'text-violet-300',
      borderColor:   'border-violet-500/20',
      bgColor:       'bg-violet-500/5',
      realCount:     count.scheduled + count.transferred,
