...
import { TrendingUp, Pencil, Trash2, Search } from 'lucide-react'
    ...
    >
      ...
      {filtered.length === 0 ? (
        ...
        <Card className="!p-0 overflow-hidden">
          {/* Header */}
          <div className="grid grid-cols-[2fr_2fr_1fr_1fr_auto] gap-4 px-6 py-3 border-b border-white/8">
            {['Cliente', 'Empreendimento', 'Data', 'Valor', ''].map((h, i) => (
          ...
          {filtered.map((s, i) => {
            ...
            return (
              <div
                key={s.id}
                className={`
                  grid grid-cols-[2fr_2fr_1fr_1fr_auto] gap-4 items-center px-6 py-4
              ...
              >
                ...
                <p className="text-sm font-semibold text-green-400">{formatCurrencyFull(s.value)}</p>
          ...
          {/* Footer total */}
          <div className="grid grid-cols-[2fr_2fr_1fr_1fr_auto] gap-4 items-center px-6 py-3 border-t border-white/8 bg-white/2">
