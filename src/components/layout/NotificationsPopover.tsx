    ...
    >
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-line">
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            onClick={onClose}
            className="w-6 h-6 flex items-center justify-center rounded-lg text-t4 hover:text-t2 hover:bg-s3/50 transition-colors cursor-pointer"
          >
            <X size={12} />
          </button>
        </div>
        ...
        {recent.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-10 gap-3">
            ...
            <div className="text-center">
              <p className="text-sm font-medium text-t3">Tudo em dia!</p>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between gap-2">
                  <p className={`text-xs font-medium leading-tight ${!n.read ? 'text-slate-100' : 'text-t3'}`}>
                    {n.title}
                  </p>
                  {!n.read && (
      ...
      <div className="border-t border-line px-4 py-2.5">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 text-xs text-t3 hover:text-brand transition-colors cursor-pointer py-1 rounded-lg hover:bg-indigo-500/8"
        >
