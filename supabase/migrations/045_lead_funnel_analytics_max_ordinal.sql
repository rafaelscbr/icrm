-- 045: corrige lead_funnel_analytics — "alcançou etapa" por profundidade máxima
--
-- A transição lead→followup acontece via advanceFollowup, que historicamente não
-- registrava evento; logo o log de stage_change é incompleto na entrada do funil.
-- "Alcançou a etapa X" passa a ser: profundidade máxima do lead (ordinal da etapa
-- atual) OU qualquer etapa tocada por evento (captura voltas/saltos pela maior
-- etapa atingida). Resultado monotônico e robusto a eventos faltantes.
