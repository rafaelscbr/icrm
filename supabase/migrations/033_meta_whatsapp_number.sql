-- ─── Migration 033: campo whatsapp_number do Instant Form ─────────────────────
-- Os formulários do Rafael usam o campo padrão "Número de WhatsApp" da Meta,
-- que chega como `whatsapp_number` no field_data — a extração só olhava
-- phone_number/phone, então leads reais entraram com telefone vazio.
-- Correção: whatsapp_number entra na cadeia do telefone (prioridade máxima,
-- já que é o canal de contato do funil) e sai das perguntas personalizadas.
