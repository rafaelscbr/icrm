-- ─── Migration 034: valores de múltipla escolha legíveis nas observações ──────
-- A Meta envia valores de múltipla escolha com underscores no lugar de espaços
-- (ex.: "r$_5.000_-_r$_10.000"). Troca por espaços ao montar as Observações
-- do lead, igual já era feito com o nome das perguntas.
